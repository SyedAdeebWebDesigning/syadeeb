...
const Sidebar = ({ userFullname, userEmail, userImg }: SidebarProps) => {
	const links = [
	...
	return (
		<aside className="flex flex-col h-[99vh] fixed top-0 w-full max-w-[18%] dark:text-white text-black">
					...
					<Link
						...
						<div className={"relative h-12"}>
							<h3 className={"logo-text"}>
								<span className={"text-primary font-extrabold"}>S</span>yed
								Adeeb
							</h3>
						</div>
					</Link>
			...
			{/* Section 2: User Card */}
			<Card className="bg-neutral-200 dark:bg-neutral-800 w-full border-neutral-300 dark:border-neutral-700">
				<CardBody className="flex flex-row items-center p-4">
					...
					<div className="ml-4 flex flex-col">
						...
						<p className="text-sm dark:text-gray-400 text-gray-600 -mt-1 mb-2">
							{userEmail}
						</p>
						<SignOutButton />
					</div>
