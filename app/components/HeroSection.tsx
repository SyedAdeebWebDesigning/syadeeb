	...
	return (
		<Vortex
			...
			<section className="h-[80vh] md:h-[80vh] flex items-center justify-center flex-col px-4 bg-background">
				...
				{/* Location and Image */}
				<div className="flex flex-col lg:flex-row items-center space-y-6 lg:space-y-0 lg:space-x-8  backdrop-blur-[2px] rounded-full p-20 overflow-y-hidden bg-white/10 dark:bg-neutral-800/10 overflow-x-hidden">
					{/* Owner Image */}
					<motion.div
						transition={{
							delay: 1,
					...
					<div className="text-center lg:text-left ">
						...
						<div className="mt-6 space-x-4 flex items-center justify-center lg:justify-start">
							...
							<motion.div
								...
								<Link
									href="https://app.enhancv.com/share/811a3201/?utm_medium=growth&utm_campaign=share-resume&utm_source=dynamic"
									target="_blank">
