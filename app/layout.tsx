...
export default function RootLayout({
    ...
    return (
        <ClerkProvider appearance={{
            baseTheme: dark,
            elements: {
                formButtonPrimary: "dark:bg-emerald-600 dark:hover:bg-emerald-700 py-2 px-3 bg-emerald-500 hover:bg-emerald-600 !shadow-none",
                ...
                footerLinkContainer: "absolute top-0 left-0 right-0 bottom-0 flex flex-col items-center justify-center hidden", // Hide by default
                signUpLink: "text-blue-500 hover:text-blue-700", // Style for sign-up link
                formFieldInput: "dark:bg-neutral-800 bg-neutral-200 py-4 px-3 text-black dark:text-white ",
                formFieldLabel: "dark:text-white text-black",
                headerTitle: "text-black dark:text-white",
                headerSubtitle: "text-black dark:text-white",
                socialButtonsBlockButton: "dark:bg-neutral-800 dark:hover:bg-neutral-800 py-2 px-3 bg-neutral-200 hover:bg-neutral-200",
                ...
                formFieldInputShowPasswordButton: "dark:text-neutral-400 text-neutral-600 hover:text-neutral-500",
                otpCodeFieldInputs: " dark:text-white text-black",
                otpCodeFieldInput: "!dark:border-neutral-200 !border-2 !border-neutral-800 dark:text-white text-black",
                formResendCodeLink: "dark:text-white text-black",
                identityPreviewText: "dark:text-neutral-200 text-neutral-800",
                identityPreviewEditButtonIcon: "dark:text-neutral-200 text-neutral-800",
                // formField
